...
const int STAGES_COUNT = 9;
const int STAGES[STAGES_COUNT] = {4, 5, 6, 7, 8, 9, 10, 11, 12};
const char *STAGE_HEADERS[STAGES_COUNT] = {
    "Minimus", "Doubles", "Minor", "Triples", "Major", "Caters", "Royal", "Cinques", "Maximus"};
const int INITIAL_STAGE_INDEX = 2; // Minor
